...
<div class="container d-flex flex-column justify-content-between vh-100">
                ...
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 mb-4">
                                <input type="email" class="form-control input-lg" id="email" name="email" aria-describedby="emailHelp" placeholder="Username" required/>
                            </div>
                            ...
                            <div class="form-group col-md-12 ">
                                <input type="password" class="form-control input-lg" id="cpassword" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password"/>
                            </div>
                            <div class="col-md-12">
    ...
    <div class="copyright pl-0">
        <p class="text-center">&copy; 2022 Copyright Company by Hamdy
        </p>
    </div>
</div>
</body>
